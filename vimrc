...
colorscheme koehler
" fix for 'koehler' colourscheme so there's a visible cursor in insert mode
hi iCursor		  guifg=bg	guibg=White
set nu
set belloff=all
set tabpagemax=25
...
inoremap <silent> <s-tab>   <C-C>:if &modifiable && !&readonly && 
     \                      &modified <CR> :write<CR> :endif<CR>:bprevious<CR>
noremap  <silent> ¬         :if &modifiable && !&readonly && 
     \                      &modified <CR> :write<CR> :endif<CR>:bnext<CR>
inoremap <silent> ¬         <C-C>:if &modifiable && !&readonly && 
     \                      &modified <CR> :write<CR> :endif<CR>:bnext<CR>
...
" C\C++ highlighting from vim-cpp-enhanced-highlight 
let g:cpp_class_scope_highlight = 1

" GTest plugin settings
let g:gtest#gtest_command = "./testrun"
